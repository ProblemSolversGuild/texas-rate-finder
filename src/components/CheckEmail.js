    ...
    return (
        <ToastContainer position='middle-center'>
            <Toast show={showToast} onClose={() => setShowToast(!showToast)} bg='light'>
                ...
                <Toast.Body>An email has been sent to the email associated with your account.  Because we get your usage from Smart Meter Texas, you have to authorize us to view your electric usage.  <br/>Once you confirm the agreement, refresh this page and your custom plan analysis will be available.  
